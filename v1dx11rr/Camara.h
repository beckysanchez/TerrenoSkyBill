...
public:
	...
	D3DXMATRIX UpdateCam(float vel, float arriaba, float izqder, float lateral)//aqui tambien tuvimos que agregar lo de lateral

	{
		...
		posCam += refRight * lateral / 10.0; //agregamos el movimiento lateral
